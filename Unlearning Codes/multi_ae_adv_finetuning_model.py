...
from functions import get_partition, get_optimizer, get_scheduler, get_lr, get_single_classification_model,get_multi_classification_model
...
class ObjectMultiLabelAdv(nn.Module):
    ...
    def __init__(self, args, adv_lambda):
        ...
        self.autoencoder = UnetGenerator(3, 3, 5, 64, norm_layer=norm_layer, use_dropout=False)
        ...
        self.adv_component =  get_multi_classification_model(args.model, len(args.target))
    ...
    def forward(self, image):
        ...
        preds = self.original_network(autoencoded_image)
