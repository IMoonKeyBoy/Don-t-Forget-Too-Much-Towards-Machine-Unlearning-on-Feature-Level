...
if __name__ == '__main__':
    ...
    parser.add_argument('-animal', default="bird", type=str)
    ...
    parser.add_argument('-fmap_path', default="/home/hengxu/Data/PycharmWorkspace/Technical Paper 3/icCNN-main-new/icCNN/basic_fmap/resnet_iccnn_optimal_80/18_resnet_bird_iccnn.npz", type=str)
    parser.add_argument('-loss_path', default="/home/hengxu/Data/PycharmWorkspace/Technical Paper 3/icCNN-main-new/icCNN/resnet/18_resnet_bird_iccnn_optimal_80/loss_2500.npz", type=str)
