...
from resnet_iccnn_train_bird import resnet_single_train
from resnet_ori_train_bird import resnet_ori_train ###
#vgg
from vgg_iccnn_train_bird import vgg_single_train
from vgg_iccnn_multi_train import vgg_multi_train
from vgg_ori_train_bird import vgg_ori_train
from vgg_ori_multi_train import vgg_ori_multi_train
##
import argparse
import random
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('-gpu', type=str, help='vgg/resnet/densenet')
