...
save_path = './icCNN/basic_fmap/vgg_iccnn_original_135/'
acc_path = './icCNN/basic_fmap/vgg_iccnn_original_135/acc/'
log_path = './icCNN/vgg/'

dataset = '%s_vgg_%s_vgg_iccnn_135' % (LAYERS, DATANAME)
log_path = log_path + dataset + '/'
pretrain_model = "/home/hengxu/Data/PycharmWorkspace/Technical Paper 3/icCNN-main-new/icCNN/vgg/13_vgg_celeb_vgg_iccnn_135/model_1300.pth"
